...
# -- Tokyo Night, contrast-boosted --
# Hues match ghostty (#1a1b26) but text/muted are brighter than stock Tokyo
# Night and the pills separate more from the bar, for readability.
export BAR_COLOR=0xff1a1b26
export ITEM_BG_COLOR=0xff2b3045
export POPUP_BG_COLOR=0xf01f2335
